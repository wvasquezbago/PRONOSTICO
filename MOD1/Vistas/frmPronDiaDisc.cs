...
{
    public partial class frmPronDiaDisc : Form
    {
        BOGeneral obj = new BOGeneral();
        public frmPronDiaDisc()
        {
            InitializeComponent();
        }

        private void frmPronDiaDisc_Load(object sender, EventArgs e)
        {
            BOGeneral dtProd = new BOGeneral();
            DataTable dt = dtProd.SelectPronDiarioDiscreto();
